...
let lclpl1 = localStorage.getItem("player") 
player1Score.innerHTML =lclpl1
let lclpl2 = localStorage.getItem("player") 
player2Score.innerHTML =lclpl2
...
function display(){
  let player1lcl = player1Score.innerHTML
  let player2lcl = player2Score.innerHTML
  localStorage.setItem("player",player1lcl)
  localStorage.setItem("player",player2lcl)
}
display();
